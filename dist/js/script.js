...
$(document).ready(function(){
	...
	$('.another_responce').click(function (e) { 
		e.preventDefault();

		$(this).before('<textarea name="response_message[]" id="response_message" cols="30" rows="3" class="form-control" style="resize: none" required=""></textarea><a class="remove_responce">Remove</a>')
		
	});

	$(document).on('click','.remove_responce',function (e) {
		e.preventDefault();
		$(this).prev().remove()
		$(this).remove()
	});
